...
const DrivingLicense = () => {
    ...
    const handleSubmitData = event => {
        ...
        const userData = { user_img: userImage, user_id:authFindUser._id,  front_page_img: userfront_page_img, back_page_img: userback_page_img, type:'Driving License' };
