...
const SingleItem = ({data}) => {
    ...
    useEffect(() => {
        if(data?.admin_id){
            fetch(`http://66.29.142.198:5000/api/admin/role/view/${data?.admin_id}`, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
    ...
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/user/support/tickets/view/by/id/${data?.support_ticket_id}`, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
    ...
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/user/support/tickets/file/view/${data?._id}`, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
                ...
                <div class="card shadow py-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <>
                            File : <small><Link to={`http://66.29.142.198:5000/${ticketFile?.attachment}`} target='_blank'> Attachment </Link></small>
                            </>
                             : '' }
                            </p>
