...
const SupportTicketsView = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/api/user/support/tickets/view/by/id/${id}`, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/api/user/support/tickets/message/view/${id}`, {
            method: 'GET',
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleSubmitData = event => {
        ...
        if (!userImage || userImage === '') {
            ...
            axios
                .post(`http://localhost:5000/api/user/support/tickets/replay/${id}`, storeData, config)
                .then(data => {
                    event.target.reset();
